	...
	<main class="flex flex-1 flex-col overflow-hidden">
		...
		<div class="border-t border-gray-200 p-4 dark:border-gray-700">
			<div class="mx-auto max-w-3xl">
				<div
					class="flex items-end gap-2 rounded-2xl border border-gray-200 bg-white px-3 py-2 shadow-sm dark:border-gray-700 dark:bg-gray-800"
				>
					<textarea
						...
						class="max-h-40 flex-1 resize-none overflow-auto bg-transparent px-2 py-2 text-sm leading-6 outline-none dark:text-white"
					></textarea>
